...
pub struct DbOrganizationDatabasePost400Response {
    #[serde(rename = "@type", skip_serializing_if = "Option::is_none")]
    pub at_type: Option<String>,
    #[serde(rename = "api:error", skip_serializing_if = "Option::is_none")]
    pub api_colon_error: Option<Box<crate::models::DbOrganizationDatabasePost400ResponseApiError>>,
...
impl DbOrganizationDatabasePost400Response {
    pub fn new() -> DbOrganizationDatabasePost400Response {
